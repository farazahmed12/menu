      ...
      <div className="container">
        <div className="row">
          <div class="card mx-2 my-2 green active font-weight-bold bg-grid">
            <div class="card-body">BEEF PEPPERONI</div>
          </div>
          <div class="card mx-2 my-2 green  font-weight-bold  bg-grid">
            <div class="card-body">MOZZARELLA CHEESE</div>
          </div>
          <div class="card mx-2 my-2 green font-weight-bold  bg-grid">
            <div class="card-body">CHICKEN FAJITA</div>
          </div>
          <div class="card mx-2 my-2 green font-weight-bold  bg-grid">
            <div class="card-body">CHICKEN SEEKH KABAB</div>
          </div>
          <div class="card mx-2 my-2 green font-weight-bold  bg-grid">
            <div class="card-body">CHICKEN SMOKE</div>
          </div>
        </div>
